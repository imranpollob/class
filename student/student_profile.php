...
<div class="panel panel-primary">
  ...
  <div class="panel-heading" style=" background-color: ;">
  		<h2 class="text-center" style="padding:10px; font-weight:bold; color:">Innovative Student</h2>
  ...
  <table style="width:100%;">
  	<tr>
  		...
  		<td><h4><?php echo $student_name; ?></h4></td>
  	</tr>

  	<tr>
  		<td><h4 style="font-weight:bold;">ID: </h4></td>
  		<td><h4><?php echo $student_id; ?></h4></td>
  	</tr>

  	<tr>
  		<td><h4 style="font-weight:bold;">Batch: </h4></td>
