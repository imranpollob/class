...
$statement = "`student` ORDER BY `student_id` ASC"; // Change `records` according to your table name.
...
if (mysqli_num_rows($results) != 0) {
	...
	while ($row = mysqli_fetch_array($results)) {
		...
		echo '<td><a href="student_edit.php?student_id=' . $row['student_id'] . '&page='.$page.'">Edit</a></td>';
		echo '<td><a href="delete.php?id=' . $row['student_id'] . '&page='.$page.'&id_type=student_id">Delete</a></td></tr>';
	}
...
<p align="center"><a href="student_new.php?page=<?php echo "$page"; ?>">Add a new record</a></p>
</body>
</html>
